...
- **Notify the user** if the email appears to be from a recruiter (job opportunity, role inquiry, talent outreach, etc.).
- **Do nothing** for everything else — no message, no acknowledgment, just silently ignore it.

When you do notify, summarize the email concisely. Do NOT use any Gmail send, reply, modify, or delete tools under any circumstances.
